...
La evaluación se ha preparado para comparar tres configuraciones compatibles con OpenAI: Groq con \nolinkurl{llama-3.3-70b-versatile}, modelo Llama 3.3 70B Instruct orientado a razonamiento general y baja latencia; Gemini con \nolinkurl{gemini-2.5-flash}, modelo Flash de Gemini 2.5 orientado a rapidez y razonamiento; y \nolinkurl{openai/gpt-oss-20b} servido mediante vLLM en el entorno universitario, modelo abierto de la familia gpt-oss usado por su capacidad de razonamiento, seguimiento de instrucciones y generación de código. El proceso de depuración principal se documentó con \nolinkurl{openai/gpt-oss-20b}; posteriormente se comprobó la misma batería compleja con Groq usando \nolinkurl{llama-3.3-70b-versatile} y se realizaron pruebas puntuales con Gemini usando \nolinkurl{gemini-2.5-flash}. En todos los casos el flujo conceptual es el mismo: análisis de la consulta, generación de código, control de seguridad, ejecución e interpretación final. Las diferencias entre proveedores se observan en latencia, estabilidad, calidad textual y cumplimiento del formato esperado.
