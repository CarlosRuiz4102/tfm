...
\begin{itemize}
    ...
    \item \texttt{results/}: almacena artefactos generados durante ejecuciones, como scripts, datos de entrada, registros y salidas JSON.
\end{itemize}
